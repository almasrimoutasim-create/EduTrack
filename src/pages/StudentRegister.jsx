          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input value={form.parent_phone} onChange={e => update("parent_phone", e.target.value)} placeholder="رقم الهاتف مع مفتاح الدولة" className="h-11 rounded-xl" dir="ltr" required />
              </div>
              <div className="space-y-1.5">
