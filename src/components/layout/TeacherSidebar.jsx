  ...
  return (
    <>
      ...
      <aside className={cn(
        ...
        {/* Logo Section — يطابق السايدبار العام: يعرض شعار واسم المدرسة المرفوع من صفحة الإعدادات */}
        <div className="p-8 pb-6">
          <div className={cn("group cursor-pointer", shortName ? "flex flex-col items-center gap-2 text-center" : "flex items-center gap-3")} onClick={() => {
            ...
            {sidebarLogoUrl && !sidebarLogoError ? (
              ...
              <div className={cn("rounded-xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300", "bg-amber-500 shadow-amber-500/30", "h-24 w-24")}>
                <BookOpen size={40} />
              </div>
            )}
